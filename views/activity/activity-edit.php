...
$crud = new Crud;
$data = $crud->selectId("activity", $_GET['id'], 'id');
?>
<!DOCTYPE html>
...
<body>
    ...
    <main>
        <div class="form-container" style="width: 50%;">
            <form action="../../class/activity.php?action=update" method="post">
                <input type="hidden" name="id" value="<?php echo $data["id"]; ?>">
                <div class="form-group">
                    <label for="type">Type d'activité</label>
                    <input type="text" class="form-control" id="type" name="type" value="<?php echo $data["type"]; ?>" placeholder="Type d'activité...">
                </div>
                <div class="form-group">
                    <label for="description">Description</label>
                    <input type="text" class="form-control" id="description" name="description" value="<?php echo $data["description"]; ?>" placeholder="Description...">
                </div>
                <div class="form-group">
                    <label for="starts_at">Date de début d'activité</label>
                    <input type="date" class="form-control" id="starts_at" name="starts_at" value="<?php echo $data["starts_at"]; ?>">
                </div>
                <div class="form-group">
                    <label for="ends_at">Date de fin d'activité</label>
                    <input type="date" class="form-control" id="ends_at" name="ends_at" value="<?php echo $data["ends_at"]; ?>">
                </div>
