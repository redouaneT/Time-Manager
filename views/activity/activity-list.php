...
$crud = new Crud;
$data = $crud->select("activity", 'id', 'ASC');
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">Début d'activité</th>
                    <th scope="col">Fin d'activité</th>
                    <th scope="col">Créée le</th>
                    <th></th>
                    <th></th>
                    <th>
                        <a class="btn btn-secondary" type="button" href="activity-add.php">Ajouter</a>
                    </th>
                </tr>
            </thead>
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" type="button" href="activity-show.php?id=<?php echo $row['id']; ?>">Voir</a>
                        </td>

                        <td><a class="btn btn-primary" type="button" href="activity-edit.php?id=<?php echo $row['id']; ?>">Modifier</a></td>
                        <td>
                            <form action="../../class/activity.php?action=delete" method="post">
