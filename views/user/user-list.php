        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col"></th>
                    <th scope="col">
                        <a class="btn btn-secondary" type="button" href="user-add.php">Ajouter</a>
                    </th>
                </tr>
            </thead>
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" type="button" href="user-show.php?id=<?php echo $row['id']; ?>">Voir</a>
                        </td>
                        <td><a class="btn btn-primary" type="button" href="user-edit.php?id=<?php echo $row['id']; ?>">Modifier</a></td>

                        <td>
                            <form action="../../class/user.php?action=delete" method="post">
