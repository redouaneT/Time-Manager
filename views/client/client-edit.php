...
$crud = new Crud;
$data = $crud->selectId("client", $_GET['id'], 'id');
?>
<!DOCTYPE html>
...
<body>
    ...
    <main>
        <div class="form-container" style="width: 50%;">
            <form action="../../class/client.php?action=update" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="phone" name="phone" value="<?php echo $data['phone'] ?>" placeholder=" Téléphone...">
                </div>
