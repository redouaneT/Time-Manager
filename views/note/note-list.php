        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th></th>
                    <th>
                        <a class="btn btn-secondary" type="button" href="note-add.php">Ajouter</a>
                    </th>
                </tr>
            </thead>
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" type="button" href="note-show.php?id=<?php echo $row['id']; ?>">Voir</a>
                        </td>

                        <td><a class="btn btn-primary" type="button" href="note-edit.php?id=<?php echo $row['id']; ?>">Modifier</a></td>
                        <td>
                            <form action="../../class/note.php?action=delete" method="post">
