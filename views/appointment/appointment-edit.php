        ...
        <div class="form-container" style="width: 50%;">
            <form action="../../class/activity.php?action=update" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="date" name="date" value="<?php echo $data["date"]; ?>" placeholder=" Date...">
                </div>
                <div class="form-group">
                    <label for="description">Description</label>
                    <input type="text" class="form-control" id="description" value="<?php echo $data["description"]; ?>" name=" description" placeholder="Description...">
                </div>
